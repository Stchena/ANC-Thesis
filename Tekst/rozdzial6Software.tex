...
Parametr $\beta$ ustawiono metodą inżynierską na wartość 0.0002. Mniejsze wartości powodują wolniejszą reakcję filtra, zaś większe przesterowują go i~powodują jego zdestabilizowanie.
