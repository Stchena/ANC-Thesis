...
Autor użył filtra typu FIR rzędu~50, czyli Finite Impulse Response, co w~polskim przekładzie oznacza filtr o~skończonej odpowiedzi impulsowej. Algorytmem optymalizującym współczynniki filtra jest LMS, czyli Least-Mean-Squares, który realizuje metodę najszybszego spadku. Typowy układ wspomniany przez autora przedstawiony jest na grafice \ref{fig:typical_fir_lms}.
\begin{figure}
	\centering
	\includegraphics[scale=0.75]{../Assets/typical_fir_lms.png}
